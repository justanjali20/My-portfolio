  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100011561623115&mibextid=rS40aB7S9Ucbxw6v"
            ...
            <li>
              <a
                href="https://www.instagram.com/justanjali.?igsh=MW82YmdmZmlvNjE2MQ=="
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/anjali-pandey-48b438256?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Anjali</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
